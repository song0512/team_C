...
public class YotBoard extends JFrame {
	...
	public YotBoard(PlayGame playObject) {
		...
		doButton = new JButton("도 확정권");
		doButton = createBoardBtn(doButton,buttonSizeX*9,buttonSizeY*7,buttonSizeX*2,buttonSizeY,true);
		doButton.setBackground(new Color(255,255,0));
		panelPan.add(doButton);
		doButton.addActionListener(play);
		
		dogButton = new JButton("개 확정권");
		dogButton = createBoardBtn(dogButton,buttonSizeX*9,buttonSizeY*6,buttonSizeX*2,buttonSizeY,true);
		dogButton.setBackground(new Color(255,255,0));
		panelPan.add(dogButton);
		dogButton.addActionListener(play);
		
		girlButton = new JButton("걸 확정권");
		girlButton = createBoardBtn(girlButton,buttonSizeX*9,buttonSizeY*5,buttonSizeX*2,buttonSizeY,true);
		girlButton.setBackground(new Color(255,255,0));
		panelPan.add(girlButton);
		girlButton.addActionListener(play);
		
		againButton = new JButton("윷 2번 던지기");
		againButton = createBoardBtn(againButton,buttonSizeX*9,buttonSizeY*4,buttonSizeX*3,buttonSizeY,true);
		againButton.setBackground(new Color(255,255,0));
		panelPan.add(againButton);
		againButton.addActionListener(play);
	...
	void buttonColor(String s)
	{
		...
		case "clickBoardOFF"://6
			...
			//확정권 버튼 
		case "doButtondON"://7
			doButton.setBackground(new Color(255,255,0));//판클릭 노랑
			break;
		case "doButtonOFF"://8
			doButton.setBackground(new Color(153,204,255));//판클릭 파랑
			break;
		case "dogButtondON"://9
			dogButton.setBackground(new Color(255,255,0));//판클릭 노랑
			break;
		case "dogButtonOFF"://10
			dogButton.setBackground(new Color(153,204,255));//판클릭 파랑
			break;
		case "girlButtondON"://11
			girlButton.setBackground(new Color(255,255,0));//판클릭 노랑
			break;
		case "girlButtonOFF"://12
			girlButton.setBackground(new Color(153,204,255));//판클릭 파랑
			break;
			//또 던지기 버튼
		case "againButtondON"://11
			againButton.setBackground(new Color(255,255,0));//판클릭 노랑
			break;
		case "againButtonOFF"://12
			againButton.setBackground(new Color(153,204,255));//판클릭 파랑
			break;
